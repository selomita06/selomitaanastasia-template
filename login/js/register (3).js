...
<head>
    ...
    <title>Soft Minimalism Login</title>
    ...
    <div class="login-container">
        <div class="soft-card">
            <div class="comfort-header">
                ...
                <h1 class="comfort-title">Create Account</h1>
                <p class="gentle-subtitle">Register to your peaceful space</p>
            </div>
            
            <form class="comfort-form" id="registerForm" novalidate>
            ...
            <div class="comfort-signup">
                ...
                <a href="index.html" class="comfort-link signup-link">Login</a>
            </div>
